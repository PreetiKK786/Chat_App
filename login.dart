...
class _LoginState extends State<Login> {
 ...
 //    sharedPreferences.steString("id", '');
  ...
  handleSignIn() async {
    ...
    if(firebaseUser != null) {
      ...
      if(result.length == 0){
       ...
       // String displayName = (sharedPreferences.getString('name') ?? '').toString();

        sharedPreferences.setString("id", firebaseUser.uid);
        sharedPreferences.setString("name",firebaseUser.displayName.toString());
        sharedPreferences.setString("profile_pic", firebaseUser.photoURL.toString());
